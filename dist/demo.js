...
var Intro = /*#__PURE__*/function () {
  ...
  _createClass(Intro, [{
    ...
    value: function enter() {
      ...
      // start the animation
      window.scrollTo(0, 0);
      _gsap.gsap.timeline().addLabel("start", 0).add(function () {
      ...
      .to([DOM.content.children, DOM.frame.children].concat(_toConsumableArray(DOM.navItems)), {
        duration: 1,
        ease: "power3.out",
        startAt: {
          opacity: 0,
